      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Здравствуйте, я <span className="text-[#915eff]">Назаров Михаил</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            Frontend-разработчик пользовательских <br className="sm:block hidden" />
            интерфейсов и веб-приложений
          </p>
        </div>
      </div>
